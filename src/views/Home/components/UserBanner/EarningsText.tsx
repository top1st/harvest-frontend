...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and HTCCAKE pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and HTCCAKE pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from HTCCAKE pool', data)
  }
